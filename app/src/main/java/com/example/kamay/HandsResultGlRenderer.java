...
public class HandsResultGlRenderer implements ResultGlRenderer<HandsResult>
{
  ...
  private static final float[] LEFT_HAND_CONNECTION_COLOR = new float[] {0.949f, 0.674f, 0.239f, 1f};
  private static final float[] RIGHT_HAND_CONNECTION_COLOR = new float[] {0.949f, 0.674f, 0.239f, 1f};
  private static final float CONNECTION_THICKNESS = 15.0f;
  private static final float[] LEFT_HAND_HOLLOW_CIRCLE_COLOR = new float[] {0.482f, 0.274f, 0.207f, 1f};
  private static final float[] RIGHT_HAND_HOLLOW_CIRCLE_COLOR = new float[] {0.482f, 0.274f, 0.207f, 1f};
  private static final float HOLLOW_CIRCLE_RADIUS = 0.00001f;
  private static final float[] LEFT_HAND_LANDMARK_COLOR = new float[] {0.482f, 0.274f, 0.207f, 1f};
  private static final float[] RIGHT_HAND_LANDMARK_COLOR = new float[] {0.482f, 0.274f, 0.207f, 1f};
